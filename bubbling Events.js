 ...
 // Event Delegation - делигирование, устанавливаем одну функцию на все необходимые события.
 ...
 //example
 var wrapper = document.querySelector("one");

 function handler(e) {
   console.log(e.target);
 }
 one.addEventListerner("click", handler);